...
mixin _$CartStore on _CartStore, Store {
  ...
  bool get loadingShipping =>
      (_$loadingShippingComputed ??= Computed<bool>(() => super.loadingShipping,
              name: '_CartStore.loadingShipping'))
          .value;
  Computed<CartData> _$cartDataComputed;

  @override
  CartData get cartData => (_$cartDataComputed ??=
          Computed<CartData>(() => super.cartData, name: '_CartStore.cartData'))
      .value;
  Computed<int> _$countComputed;

  @override
  int get count => (_$countComputed ??=
          Computed<int>(() => super.count, name: '_CartStore.count'))
      .value;
  Computed<String> _$cartKeyComputed;

  @override
  String get cartKey => (_$cartKeyComputed ??=
          Computed<String>(() => super.cartKey, name: '_CartStore.cartKey'))
      .value;
  ...
  Future<void> selectShipping(
      {dynamic packageId = int, dynamic rateId = String}) {
  ...
  final _$updateCustomerCartAsyncAction =
      AsyncAction('_CartStore.updateCustomerCart');
