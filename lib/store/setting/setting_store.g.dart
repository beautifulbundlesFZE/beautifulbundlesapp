...
mixin _$SettingStore on _SettingStore, Store {
  ...
  bool get darkMode => (_$darkModeComputed ??=
          Computed<bool>(() => super.darkMode, name: '_SettingStore.darkMode'))
      .value;
  ...
  String get themeModeKey =>
      (_$themeModeKeyComputed ??= Computed<String>(() => super.themeModeKey,
              name: '_SettingStore.themeModeKey'))
          .value;
  ...
  String get languageKey =>
      (_$languageKeyComputed ??= Computed<String>(() => super.languageKey,
              name: '_SettingStore.languageKey'))
          .value;
  Computed<String> _$localeComputed;

  @override
  String get locale => (_$localeComputed ??=
          Computed<String>(() => super.locale, name: '_SettingStore.locale'))
      .value;
  ...
  ObservableList<Language> get supportedLanguages =>
      (_$supportedLanguagesComputed ??= Computed<ObservableList<Language>>(
              ...
              name: '_SettingStore.supportedLanguages'))
          .value;
  Computed<bool> _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??=
          Computed<bool>(() => super.loading, name: '_SettingStore.loading'))
      .value;
  ...
  PersistHelper get persistHelper => (_$persistHelperComputed ??=
          Computed<PersistHelper>(() => super.persistHelper,
              name: '_SettingStore.persistHelper'))
      .value;
  ...
  RequestHelper get requestHelper => (_$requestHelperComputed ??=
          Computed<RequestHelper>(() => super.requestHelper,
              name: '_SettingStore.requestHelper'))
      .value;
  Computed<String> _$defaultCurrencyComputed;

  @override
  String get defaultCurrency => (_$defaultCurrencyComputed ??= Computed<String>(
          () => super.defaultCurrency,
          name: '_SettingStore.defaultCurrency'))
      .value;
  ...
  bool get isCurrencyChanged => (_$isCurrencyChangedComputed ??= Computed<bool>(
          ...
          name: '_SettingStore.isCurrencyChanged'))
      .value;
  ...
  String get checkoutUrl =>
      (_$checkoutUrlComputed ??= Computed<String>(() => super.checkoutUrl,
              name: '_SettingStore.checkoutUrl'))
          .value;
  Computed<DataScreen> _$dataComputed;

  @override
  DataScreen get data => (_$dataComputed ??=
          Computed<DataScreen>(() => super.data, name: '_SettingStore.data'))
      .value;
  Computed<ObservableList<String>> _$tabsComputed;

  @override
  ObservableList<String> get tabs =>
      (_$tabsComputed ??= Computed<ObservableList<String>>(() => super.tabs,
              name: '_SettingStore.tabs'))
          .value;
  ...
  bool get enableGetStart =>
      (_$enableGetStartComputed ??= Computed<bool>(() => super.enableGetStart,
              name: '_SettingStore.enableGetStart'))
          .value;

  final _$_supportedLanguagesAtom =
      Atom(name: '_SettingStore._supportedLanguages');
  ...
  final _$changeLanguageAsyncAction =
      AsyncAction('_SettingStore.changeLanguage');
  ...
  final _$changeCurrencyAsyncAction =
      AsyncAction('_SettingStore.changeCurrency');
