...
class LayoutMasonry extends StatelessWidget with LoadingMixin {
  ...
  final Widget Function(BuildContext context, {Post post, int index, double widthView, double width, double height})
      buildItem;
  final double pad;
  ...
  Widget _buildList(context, {List<int> items, int mod = 1, double width, double height}) {
    return Column(
