...
class _ProductScreenState extends State<ProductScreen> with Utility, SnackMixin, LoadingMixin, NavigationMixin {
  AppStore _appStore;
  ...
  ///
  /// Handle add to cart
  Future<void> _handleAddToCart([bool goCartPage = false]) async {
