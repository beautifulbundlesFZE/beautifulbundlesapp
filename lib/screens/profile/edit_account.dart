...
class _EditAccountScreenState extends State<EditAccountScreen> with SnackMixin, AppBarMixin, LoadingMixin {
  ...
  Widget renderFirstName({TranslateType translate}) {
  ...
  Widget renderLastName({TranslateType translate}) {
    return TextFormField(
  ...
  Widget renderDisplayName({TranslateType translate}) {
    return TextFormField(
  ...
  Widget renderEmail({TranslateType translate}) {
    return TextFormField(
