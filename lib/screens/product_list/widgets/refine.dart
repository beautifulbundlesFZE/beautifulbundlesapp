    ...
    return CirillaTile(
      ...
      title: RichText(
        text: TextSpan(
          text: option.name,
          children: [
            TextSpan(text: ' (${option.count.toString() ?? '0'})', style: theme.textTheme.overline),
          ],
...
class _Category extends StatelessWidget {
  ...
  Widget _buildListTitle(BuildContext context, {bool isSub, bool expand, String key}) {
    ThemeData theme = Theme.of(context);
        ...
        CirillaTile(
          ...
          title: RichText(
            text: TextSpan(
              ...
              children: [
                if (category.count > -1)
                  TextSpan(text: ' (${category.count.toString() ?? '0'})', style: theme.textTheme.overline),
              ],
              style: theme.textTheme.bodyText2.copyWith(color: textColor),
            ),
          ),
