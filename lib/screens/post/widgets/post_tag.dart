  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(left: paddingHorizontal, right: paddingHorizontal, top: itemPaddingExtraLarge),
          child: Text(translate('comment_s'), style: theme.textTheme.subtitle1),
        ),
      ],
    );
  }
