...
class _PostScreenState extends State<PostScreen> with PostMixin, AppBarMixin, SnackMixin, LoadingMixin {
  ...
  Widget buildLayout(Post post) {
    return Observer(builder: (_) {
      ...
      // Configs
      WidgetConfig configs = data != null ? data.widgets['postDetailPage'] : null;

      // Layout
      String layout = configs != null ? configs.layout : Strings.postDetailLayoutDefault;
      ...
      return PostHtml(post: post, layout: layout, styles: configs.styles);
    });
  }
}
