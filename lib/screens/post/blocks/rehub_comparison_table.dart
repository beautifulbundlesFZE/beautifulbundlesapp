...
class RehubComparisonTable extends StatelessWidget with Utility {
        ...
        return SingleChildScrollView(
          ...
          child: Table(
            ...
            children: <TableRow>[
              ...
              if (enableBottom)
                buildInfo(context, innerBlocks: innerBlocks, theme: theme, title: bottomTitle, nameValue: 'bottomText'),
              if (enablePros)
  ...
  TableRow buildBadge({List innerBlocks, ThemeData theme}) {
    return TableRow(
      children: <Widget>[
        Container(),
                ...
                children: [
                  ...
                  Positioned.directional(
                    ...
                    child: enableNumbers
                        ? Badge(
                            text:
                                Text(number.toString(), style: theme.textTheme.subtitle1.copyWith(color: Colors.white)),
                            size: 30,
                            color: numberColor,
                          )
                        : Container(),
  ...
  TableRow buildInfo(BuildContext context, {String title, List innerBlocks, ThemeData theme, String nameValue}) {
    return TableRow(
      children: <Widget>[
        TableCell(
          child: buildBox(
  ...
  TableRow buildButtonCallout(BuildContext context, {List innerBlocks, ThemeData theme}) {
    TranslateType translate = AppLocalizations.of(context).translate;
    return TableRow(
      children: <Widget>[
        Container(),
