...
class CartScreenState extends State<CartScreen>
                ...
                AnimatedList(
                  ...
                  itemBuilder: (context, index, animation) {
                    if (index == _items.length) {
                      return buildCoupon(context, _cartStore, enableGuestCheckout);
                    }
  ...
  Widget buildCoupon(BuildContext context, CartStore cartStore, bool enableGuestCheckout) {
    return Padding(
