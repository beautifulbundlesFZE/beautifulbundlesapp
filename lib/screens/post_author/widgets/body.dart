...
class _BodyState extends State<Body> with PostAuthorMixin, LoadingMixin {
  ...
  void didChangeDependencies() {
    ...
    _postStore = PostStore(_settingStore.requestHelper, perPage: 10, authors: [widget.author.id]);
  ...
  SliverAppBar buildAppbar({PostAuthor author, ThemeData theme, TranslateType translate}) {
    ...
    return SliverAppBar(
      ...
      //     child: Row(
      //       children: [
      //         Icon(FeatherIcons.barChart2, size: 20, color: theme.primaryColor),
      //         SizedBox(width: 8),
      //         Text(translate('product_list_sort')),
      //       ],
      //     ),
